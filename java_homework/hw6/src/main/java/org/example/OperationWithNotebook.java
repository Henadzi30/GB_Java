...
public class OperationWithNotebook {
    ...
    public void printList(){
        for (Notebook notebook : notebooks){
            if (pcIsCorrect(notebook)){
                System.out.println(notebook);
            }
        }
    }

    public boolean pcIsCorrect(Notebook notebook){
        ...
        for (Criterion criterion : criterionList){
            ...
            }else if (criterion.property.equals("CPI")){
    ...
    public OperationWithNotebook(Set<Notebook> pcs) {
        this.scanner = new Scanner(System.in);
        this.notebooks = pcs;
    }

    public OperationWithNotebook(Set<Notebook> pcs, List<Criterion> criterionList) {
        this.scanner = new Scanner(System.in);
        this.notebooks = pcs;
